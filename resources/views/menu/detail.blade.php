            ...
            <div class="card-body" style="justify-content: left; display: flex; align-items: center;">
                <div style="flex-grow: 1; display: flex; justify-content: space-between;">
                    <div style="width: 60%;">
                        ...
                        <div style="text-align: left; justify-content: space-between; margin-top: 5%;">
                            <a href="{{ route('menu.index') }}" class="btn  btn-delete" style=" background-color: #fff; color: #4f60e0; border: 1px solid #4f60e0; border-radius: 25px; cursor: pointer; width: 100px; text-align: center; display: inline-block;">Kembali</a>
                            <a href="{{ route('menu.update') }}" class="btn  btn-delete" style=" background-color: #4f60e0; color: #fff; border: none; border-radius: 25px; cursor: pointer; width: 100px; text-align: center; display: inline-block;">Update</a>
                        </div>
                    </div>
