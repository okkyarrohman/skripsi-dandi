        ...
        <div class="w-full">
            <span class="card shadow text-decoration-none" style="display: flex; ">
                <div class="card-body" style="justify-content: left;">
                    ...
                    <form class="form-horizontal" action="{{ route('bahan.update', ['id' => $bahans->id]) }}" method="POST"
                        ...
                        <div style="display: flex; flex-wrap: wrap;">
                            <div style="flex: 1; margin-right: 10px;">
                                ...
                                <div class="input-group input-group-merge" style="max-width: 400px; margin-bottom: 10px;">
                                    <input type="text" name="name" value="{{ $bahans->name }}" class="form-control"
                                        placeholder="Nama..." aria-describedby="basic-addon-search31">
                                </div>
                                ...
                                <div class="input-group input-group-merge"
                                    ...
                                    <input type="text" name="stokAkhir" value="{{ $bahans->stokAkhir }}"
                                        class="form-control" placeholder="Stok akhir..."
                                        aria-describedby="basic-addon-search31">
                                    <span style="margin: 0 6px;">Dari</span>
                                    <input type="text" readonly name="stokAwal" value="{{ $bahans->stokAwal }}"
                                        class="form-control" placeholder="Stok awal..."
                                        aria-describedby="basic-addon-search31">
                                </div>
                            ...
                            <div style="flex: 1;">
                                <<<<<<< HEAD=======>>>>>>> edfe97a6ebded720bfe69098adfac1cc3a9f07dd
                            </div>
                        </div>

                        <div style="text-align: left; justify-content:space-between; margin-top:3%;">
                            <a href="{{ route('bahan.index') }}" class="btn  btn-delete"
